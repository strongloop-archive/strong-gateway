...
// "OAuth token"
var OAuthToken = loopback.createModel('OAuthToken', {
  // "access token"
  accessToken: {
    type: String,
    index: {
...
var OAuthAuthorizationCode = loopback.createModel('OAuthAuthorizationCode', {
  code: {
    type: String,
    index: {
      unique: true
...
var ClientRegistration = loopback.createModel('ClientRegistration', {
  id: {
    type: String,
    index: {
      unique: true
...
// "OAuth permission"
var OAuthPermission = loopback.createModel('OAuthPermission', {
  clientId: {
    type: String,
    index: true
  }, // The client id
...
// "OAuth scope"
var OAuthScope = loopback.createModel('OAuthScope', {
  scope: {
    type: String,
    index: {
      unique: true
...
var OAuthResource = loopback.createModel('OAuthResource', {
  operations: [
    {
      type: String,
...
exports.attachTo = function(ds) {
  exports.OAuthToken.attachTo(ds);
  exports.OAuthAuthorizationCode.attachTo(ds);
  exports.ClientRegistration.attachTo(ds);
  exports.OAuthPermission.attachTo(ds);
  exports.OAuthScope.attachTo(ds);
  exports.OAuthResource.attachTo(ds);
};